...
# Builder stage
FROM eclipse-temurin:26.0.1_8-jre-noble AS builder
...
RUN curl -sLJ https://download.structurizr.com/structurizr-2026.05.22.war --output-dir /structurizr-cli --output structurizr.war && \
